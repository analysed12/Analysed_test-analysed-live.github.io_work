...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="index.php"><img src="img/main-logo.png" alt=""
                    class="img-fluid"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <div class="navbar-nav text-uppercase pt-3 ml-auto nav-form-s">
                    <button type="submit" class="btn btn-primary mb-2 ml-2 mr-3" data-toggle="modal"
                ...
                <div class="modal-body">
                    <form action="signup/jobSeeker/jobSeekerLogIn.php" method="POST">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="js_email" name="js_email"
            ...
            <div class="row h-100">
                <div class="col-lg-7 my-auto">
                    <div class="header-content mx-auto animated wow zoomIn" data-wow-duration="0.3s"
                        ...
                        <p>Recruitment and hiring process has been a complex task for a long time and we plan to change
                            that. Analysed helps recruiters in human analytics through AI and provides them with virtual
                            testing tools to lighten the burden of the struggle for both recruiters and job aspirants.
                            Let's eliminate together the troubles witnessed in the recruitment process and uncover a one
                            stop solution to it.</p>
                        <a href="signup/recruiter/index.php"><button class="btn btn-white mt-4 py-2 px-3 ">SIGN UP <i
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="about-content-box wow  align-center fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h5>Aspirant</h5>
                        <p class="desc align-center">Job aspirants need to upload their resume and other important
                            details for the virtual recruitment drive.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="about-content-box wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5>How it Works</h5>
                        <p class="desc">Analysed strides with an advanced technology to reduce the unemployment rate and
                            bridge the gap between education and corporate requirements.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="about-content-box wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <h5>Recruiters</h5>
                        <p class="desc">A recruiter will be able to create their own virtual recruitment cell and set
                            parameters according to their needs and requirements.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row first">
                ...
                <div class="col-md-6 m-auto wow fadeInLeft" data-wow-delay="0.6s">
                    <div class="app-about-cont">
                        ...
                        <p class="text-justify">Analysed is different from every other job searching platforms as it
                            offers exclusive technologically advanced tools to perform disparate functions or the
                            recruitment process. We extensively provide tools and services to lighten the burden of the
                            process.</p>
                    </div>
                </div>
            </div>
            <div class="row second">
                ...
                <div class="col-md-6 m-auto wow fadeInRight" data-wow-delay="0.3s">
                    <div class="app-about-cont right">
                        ...
                        <p class="text-justify">Our advantages are that we put our belief into this essential cause.
                            Being an unbiased platform that extensively provides services to both recruiters and job
                            seekers, we tend to make our platform a uniform and even one. We aim at using technology as
                            a tool to fix the currently flawed recruitment process and job searching platforms.</p>
                    </div>
                </div>
            ...
            <div class="row first first-three ">
                ...
                <div class="col-md-6 m-auto wow fadeInLeft" data-wow-delay="0.6s">
                    <div class="app-about-cont">
                        <i class="fa fa-cog"></i>
                        <h3>Our Services</h3>
                        <p class="text-justify">We do not augment that we transform your big dreams to reality, we just
                            commence with little ones. Bridging the gap between a recruiter and an aspirant is our sole
                            motive. We, at Analysed, believe that every person holds a potential to reach at zenith of
                            their career.</p>
                    </div>
                </div>
            </div>
    ...
    <footer>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 ">
                            ...
                            <ul class="list-unstyled link-list">
                                ...
                                <li> <i class="fa fa-angle-right"></i> <a href="./privacy-policy.php">Privacy Policy</a>
                                </li>
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <ul class="list-unstyled link-list">
                                <address class="address-details-f">
                                    ...
                                    <li> <b>Email</b>: <a href="mailto:support@analysed.in"
                                            class="">support@analysed.in</a> </li>
                                </address>
                            </ul>
                        </div>
                        <!-- End Latest Tweets -->
                        ...
                        <div class="col-md-3 col-sm-6 ">
                            ...
                            <ul class="list-unstyled link-list">
                                <li> <i class="fa fa-angle-right"></i> <a href="https://www.facebook.com/team"
                                        target="_blank">Facebook</a></li>
                                <li> <i class="fa fa-angle-right"></i> <a href="https://twitter.com/TeamAnalysed"
                                        target="_blank">Twitter</a></li>
                                <li> <i class="fa fa-angle-right"></i> <a
                                        href="https://www.linkedin.com/company/analysed-in/"
                                        target="_blank">LinkedIn</a></li>
                                <li> <i class="fa fa-angle-right"></i> <a
                                        href="https://plus.google.com/u/1/109256659736789411787" target="_blank">Google
                                        Plus</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 ">
                            ...
                            <form name="contact-form" method="post"
                                action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . '#main-contact-form2')?>">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" name="message" id="exampleFormControlTextarea1"
                                        rows="3" placeholder="Enter your message" required="required"></textarea>
                                </div>
        ...
        <a href="#home" id="back-to-top" class="btn btn-sm btn-green btn-back-to-top smooth-scroll hidden-sm hidden-xs"
    ...
    <script
        src="https://lex-web-mx-codebuilddeploy-1k71slxns-webappbucket-rseursdbynux.s3.amazonaws.com/lex-web-ui-loader.min.js">
    </script>
    <script>
    var loaderOpts = {
