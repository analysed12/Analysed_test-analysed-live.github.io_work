...
<link rel="stylesheet" href="./css/appliedCandidates_remov.css">
    ...
    <div class="container">
        ...
        <div class="small_container">
            <div class="bread-crumbs_Mytools-recruiter">
                <a href="dashboard.php" class="unactive-breadcrumb-link">Dashboard</a> > <a href=""
                    class="active-breadcrumb-link">Applied Candidates</a>
            </div>
            <form action="" method="post">
                <div class="row-flex-jobs-j alignitemsstart-shortlisted Dashboard-main-container-jobs">
                    ...
                    ?>
                        ...
                        <h2 class="jobsCreateaDashboard-jobs">Applied Candidates <span>
                                (<?php echo htmlentities($num); ?>)</span></h2>
                                ...
                                if($status=="Hired"){ ?>
                                    ...
                                    <div class="row-flex-jobs-j seemorebutton-social">
                                        ...
                                        <div class="row-flex-jobs-j social-media-icons">
                                            <a href="https://www.linkedin.com/shareArticle?mini=true&url=<URL>&t=<TITLE>"
                                                onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
                                                target="_blank" title="Share on Linkedin"><img
                                                    src="./img/Icon zocial-linkedin.svg" alt=""></a>
                                            <a href="https://twitter.com/share?url=<URL>&text=<TITLE>"
                                                onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
                                                target="_blank" title="Share on Twitter"><img
                                                    src="./img/Icon feather-twitter.svg" alt=""></a>
                                            <a href="mailto:?subject=[SUBJECT]&body=<URL>"
                                                onClick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
                                                target="_blank" title="Share on Mail"><img
                                                    src="./img/Icon material-mail-outline.svg" alt=""></a>
                                        </div>
                                    </div>
        ...
        <form class="form">
            <div class="category-main-first">
                ...
                <input type="text" name="jobtitle" id="jobtitle" placeholder="Job Title"
                    class="input-applied-candidates" oninput="myFunction()">

            </div>
            <div class="category-main-first">

                <label for="Location" class="label-applied-candidates"><b>Location</b></label>
                <input type="text" name="location" id="location" placeholder="Location" class="input-applied-candidates"
                    oninput="myFunction()">
                    ...
                    <div class="row-flex-jobs-j">
                        <span>
                            <label class="qualification">
                                <input type="checkbox" value="<?= $row['qualification'];?>" id="qualification"
                                    onclick="myFunction()"><span> </span><?= $row['qualification']; ?>
                            </label>
                        </span>
                        <p>
                            <?php
                    ...
                    <div class="row-flex-jobs-j">
                        <span>
                            <label class="job_type">
                                <input type="checkbox" value="<?= $row['job_type'];?>" id="job_type"
                                    onclick="myFunction()"><span> </span><?= $row['job_type']; ?>
                            </label>
                        </span>
                        <p>
                            <?php
            ...
            <div class="category-main-first">
                ...
                <div class="category-filters" id="categoryDiv5">
                    ...
                    <div class="row-flex-jobs-j">
                        <span>
                            <label class="job_type">
                                <input type="checkbox" value="<?= $row['status'];?>" id="status"
                                    onclick="myFunction()"><span> </span><?= $row['status']; ?>
                            </label>
                        </span>
                        <p>
                            <?php
