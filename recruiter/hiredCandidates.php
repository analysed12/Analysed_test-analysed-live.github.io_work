...
<link rel="stylesheet" href="./css/hiredCandidates_remove.css">
    ...
    <div class="container">
        ...
        <div class="small_container">
            <div class="bread-crumbs_Mytools-recruiter">
                <a href="dashboard.php" class="unactive-breadcrumb-link">Dashboard</a> > <a href="hiredCandidates.php"
                    class="active-breadcrumb-link">Hired Candidates</a>
            </div>
            <div class="row-flex-jobs-j alignitemsstart-shortlisted Dashboard-main-container-jobs">
                <div class="left-side-container-DashboardJ">
                    ...
                    ?>
                    <h2 class="jobsCreateaDashboard-jobs">Hired Candidates
                    ...
                    <div class="cards-section-container row-flex-jobs-j" id="result">
                        ...
                        <div class="single-container-cards-DasboardJobs candidatesjobs-applied">
                            <a href="">
                                <div class="candidate-status-jobs hiredCandidates-img">
                                    <p>NEW</p><img src="./img/Path 2213.svg">
                                </div>
                                ...
                                <div class="row-flex-jobj email-id-and-experience">
                                    ...
                                    <span>
                                        <p class="grey-email-id">Email ID</p>
                                        <p class="name-dark-id"><?php echo $row["js_email"]; ?></p>
                                    </span>
                                </div>
                                <div class="row-flex-jobj email-id-and-experience">
                                    ...
                                    <span class="span-experience-1">
                                        ...
                                        <p class="name-dark-id row-flex-jobs-j"><span>Total</span>
                                            <span><?php echo $row["experience"]; ?> Years Experience </span>
                                        </p>
