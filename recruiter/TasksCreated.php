    ...
    <div class="container">
        <div class="small_container">
            <div class="bread-crumbs_Mytools-recruiter">
                <a href="dashboard.php" class="unactive-breadcrumb-link">Dashboard</a> > <a href="TasksCreated.php"
                    class="active-breadcrumb-link">Tasks Created</a>
            </div>
            <div class="row-flex-jobs-j alignitemsstart-shortlisted Dashboard-main-container-jobs">
                <div class="left-side-container-DashboardJ">
                    ...
                    ?>
                    <h2 class="jobsCreateaDashboard-jobs">Tasks Created<span> (<?php echo htmlentities($num); ?>)</span>
                    </h2>
                        ...
                        <div class="single-container-cards-DasboardJobs candidatesjobs-applied">
                            <a href="">
                                ...
                                <div class="upcomingInterviews-p tasks-created-p">
                                    ...
                                    <p class="row-flex-jobj"><img src="./img/Calendar(1).svg"
                                            style="margin-right: 10px;"><?php echo $start_date; ?>to
                                        <?php echo $end_date; ?> </p>
                    ...
                    <form class="form">
                        <div class="category-main-first">
                            ...
                            <input type="text" id="jobtitle" placeholder="Job Title" class="input-applied-candidates"
                                oninput="myFunction()" onclick="myFunction()">

                        </div>
                        <div class="category-main-first">

                            <label for="CompanyName" class="label-applied-candidates"><b>Company Name<b /></label>
                            <input type="text" id="company" placeholder="Company Name" class="input-applied-candidates"
                                oninput="myFunction()" onclick="myFunction()">
                        ...
                        <div class="category-main-first">
                            ...
                            <input type="text" id="skills" placeholder="Skills" class="input-applied-candidates"
                                oninput="myFunction()" onclick="myFunction()">
