        ...
        <div class="row-recruiter container-for-add-client-main">
            <div class="left-side-row-for-add-client-container-1">
                <p class="links-for-add-client-low-side-row-for-add-client active" id="link-categories-addClient-1"><a
                        href="edit-Candidates1.php?c_id=<?php echo $c_id?>" class="inactive">Personal infromation</a>
                </p>
                <p class="links-for-add-client-low-side-row-for-add-client" id="link-categories-addClient-2"><a href="#"
                        class="page-active">Professional infromation</a></p>
                <p class="links-for-add-client-low-side-row-for-add-client" id="link-categories-addClient-3"><a
                        href="edit-Candidates3.php?c_id=<?php echo $c_id?>" class="inactive">Skills & Qualification</a>
                </p>
                <p class="links-for-add-client-low-side-row-for-add-client" id="link-categories-addClient-3"><a
            ...
            <div class="right-side-row-for-add-client-container-1 " id="general-information-addclient-1">
                <div class="row-recruiter sub-divs-image-child-main-heading" style="margin-bottom: 30px;">
                    <img src="./img/professional.png" width="50px" style="margin-right: 30px;">
                    <h2 class="heading-for-general-information-right-side-add-client-container" class="inactive">
                        ...
                        <div class="right-side-image-box-right-add-client-1">
                            <div class="row-recruiter sub-divs-image-box-right-side-add-client">
                                <p class="input-para-add-client-ekam-1 fx-city-name-1 fb-2">
                                    ...
                                    <input type="text" name="currentTitle" class="default-input-for-add-client-1"
                                        ...
                                        value="<?php echo $row['current_title']; ?>" required />
                                </p>
                                <p class="input-para-add-client-ekam-1 fx-city-name-1 fb-2">
                            ...
                            <div class="row-recruiter sub-divs-image-box-right-side-add-client">
                                <p class="input-para-add-client-ekam-1 right-side fx-city-name-1 fb-2">
                                    ...
                                    <option value="<?php echo $row['candidate_type']; ?>" default>
                                        <?php echo $row['candidate_type']; ?></option>
                                ...
                                <p class="select-for-select-image-box-below-inputs fx-city-name-1 fb-2">
                                    ...
                                    <select name="employmentPreference" id="default-select-for-no.3"
                                        class="default-select-for-add-client-1" required />
                                    <option value="<?php echo $row['emp_preference']; ?>" default>
                                        <?php echo $row['emp_preference']; ?></option>
                            ...
                            <div class="row-recruiter sub-divs-image-box-right-side-add-client">
                                <p class="select-for-select-image-box-below-inputs fx-city-name-1 fb-2">
                                    ...
                                    <select name="source" id="default-select-for-no.3"
                                        class="default-select-for-add-client-1" required />
                                    <option value="<?php echo $row['source']; ?>" default><?php echo $row['source']; ?>
                                    </option>
                                ...
                                <p class="select-for-select-image-box-below-inputs fx-city-name-1 fb-2">
                                    ...
                                    <select name="recruiter" id="default-select-for-no.3"
                                        class="default-select-for-add-client-1" required />
                                    <option value="<?php echo $row['recruiter']; ?>" default>
                                        <?php echo $row['recruiter']; ?></option>
                            ...
                            <div class="row-recruiter sub-divs-image-box-right-side-add-client">
                                <p class="input-para-add-client-ekam-1 fx-city-name-1 fb-2">
                                    ...
                                    <input type="text" name="currentSalary" class="default-input-for-add-client-1"
                                        placeholder="Company URL" id="default-input-for-no.2"
                                        value="<?php echo $row['current_salary']; ?>" required />
                                </p>
                                <span class="input-para-add-client-ekam-1 desired-salary-p fb-2">
                                    ...
                                    <span class="row-recruiter">
                                        <input type="text" name="salaryRange1"
                                            ...
                                            placeholder="Company URL" id="default-input-for-no.2"
                                            value="<?php echo $row['salary_range1']; ?>" required /> to
                                        <input type="text" name="salaryRange2"
                                            class="default-input-for-add-client-1 desired-salary"
                                            placeholder="Company URL" id="default-input-for-no.2"
                                            value="<?php echo $row['salary_range2']; ?>" required />
                                    </span>
                                </span>
                            </div>
                        </div>
