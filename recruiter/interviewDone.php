...
<link rel="stylesheet" href="./css/interviewDone_remov.css">
        ...
        <div class="small_container">
            ...
            <div class="row-flex-jobs-j alignitemsstart-shortlisted Dashboard-main-container-jobs">
                ...
                <div class="left-side-container-DashboardJ">
                    ...
                    <h2 class="jobsCreateaDashboard-jobs">Interviews Done<span> (<?php echo htmlentities($num); ?>)
                        </span></h2>
                        ...
                        <div class="single-container-cards-DasboardJobs candidatesjobs-applied">
                            <a href="">
                                ...
                                <div class="row-flex-jobj">
                                    <p class="jobStatus-interviewDone notactive"><span></span>
                                        <?php echo $row['company']; ?> </p>
                                </div>
                                ...
                                <a href="" class="resumepdfDownload row-flex-jobj"><img src="./img/File.svg"
                                        style="margin-right: 10px;width:20px"><?php echo $row["Resume"]; ?></a>
                    ...
                    <form class="form">
                        ...
                        <div class="category-main-first">
                            ...
                            <input type="text" id="position" placeholder="Job Title"
                                class="input-applied-candidates product_check" name="position" oninput="myFunction()"
                                onclick="myFunction()" autocomplete="off">
                        ...
                        <div class="category-main-first">
                            ...
                            <input type="text" id="company" placeholder="Company Name"
                                class="input-applied-candidates product_check" name="company" oninput="myFunction()"
                                onclick="myFunction()" autocomplete="off">
                                    ...
                                    <span>
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input product_check"
                                                value="<?= $row['status'];?>" id="status" onclick="myFunction()"><span>
                                            </span><?= $row['status']; ?>
                                        </label>
                                    </span>
                                    <p>
