        ...
        <div class="row-recruiter container-for-add-client-main">
            <div class="left-side-row-for-add-client-container-1">
                <p class="links-for-add-client-low-side-row-for-add-client active" id="link-categories-addClient-1"><a
                        href="addCandidates1.php" class="active">Personal infromation</a></p>
                ...
                <p class="links-for-add-client-low-side-row-for-add-client" id="link-categories-addClient-3"><a
                        href="edit-Candidates4.php">Additional information</a></p>
            </div>
                    ...
                    <div class="right-side-image-box-right-add-client-1">
                        <div class="row-recruiter sub-divs-image-box-right-side-add-client">
                            ...
                            <div class="input-signup-div fx-city-name-1">
                                ...
                                <div class="phn-number-div row-signup" style="flex-wrap: nowrap;"><select name="code">
                                        <option value="+91">+91</option>
                                    </select><input type="tel" maxlength='10' name="phonenumber"
                                        placeholder="Phone number" id="input-first-name"
                                        class="phn-number--input-signup" value="<?php echo $row['phone_no']; ?>"></div>
                            </div>
                            <p class="input-para-add-client-ekam-1 fx-city-name-1">
                            ...
                            <p class="select-for-select-image-box-below-inputs fx-city-name-1">
                                ...
                                <select name="Industry" id="default-select-for-no.3"
                                    ...
                                    <option value="<?php echo $row['status']; ?>" default><?php echo $row['status']; ?>
                                    </option>
                            ...
                            <p class="select-for-select-image-box-below-inputs  fx-city-name-1">
                                ...
                                <select name="State" id="default-select-for-no.6"
                                    class="default-select-for-add-client-1">
                                    <option value="<?php echo $row['state']; ?>" default><?php echo $row['state']; ?>
                                    </option>
                        ...
                        <input href="edit-Candidates2.php?edit_Candidates1=<?php echo $row['candidate_id'];?>"
